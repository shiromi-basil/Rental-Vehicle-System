...
public class ManagerConsole {
    RentalVehicleSystemManager manager = new RentalVehicleSystemManager();
     ...
     */
    public void login() {
        System.out.println("Welcome Rental Vehicle System Service!");
        ...
        while (!loginFlag) {
            ...
            if ((username.equals(RentalVehicleSystemManager.USERNAME)) &&
                    (password.equals(RentalVehicleSystemManager.PASSWORD))) {
                loginFlag = true;
                break;
        ...
        while (!userInputOption) {
            ...
            switch (mainOption) {
                case "1":
                    ...
                    Vehicle addCar = userInputAddCar();
                ...
                case "2":
                    ...
                    System.out.println("Please enter the Plate No of the car you want " +
                            "to delete: ");
                    Vehicle deleteCar = userInputSearchCar();
                    System.out.println(deleteCar);
                    String carConfirm = userInputString("Do you want to delete the " +
                            "above car from the " +
                            "database? (Yes/No)").toLowerCase();
                    if (carConfirm.equals("yes")) {
                ...
                case "3":
                    ...
                    System.out.println("Please enter the Plate No of the car you want " +
                            "to view: ");
                    Vehicle viewCar = userInputSearchCar();
        ...
        while (!userInputOption) {
            ...
            switch (mainOption) {
                case "1":
                    ...
                    Vehicle addMotorbike = userInputAddMotorbike();
                ...
                case "2":
                    ...
                    System.out.println("Please enter the Plate No of the motorbike you " +
                            "want to delete: ");
                    Vehicle deleteMotorbike = userInputSearchMotorbike();
                    System.out.println(deleteMotorbike);
                    String bikeConfirm = userInputString("Do you want to delete the " +
                            "above motorbike from the " +
                            "database? (Yes/No)").toLowerCase();
                    if (bikeConfirm.equals("yes")) {
                ...
                case "3":
                    ...
                    System.out.println("Please enter the Plate No of the motorbike you " +
                            "want to view: ");
                    Vehicle viewMotorbike = userInputSearchMotorbike();
        ...
        while (!userInputOption) {
            ...
            switch (mainOption) {
                ...
                case "2":
                    ...
                    String cusConfirm = userInputString("Do you want to delete the " +
                            "above customer from the " +
                            "database? (Yes/No)").toLowerCase();
                    if (cusConfirm.equals("yes")) {
     ...
     */
    public Vehicle userInputAddCar() {
        ...
        Vehicle car = new Car(vPlateNo, vMake, vModel, vTransmission, vRatePerDay,
                cNoOFDoors,
                cNoOFSeats, cAirCondition);
        return car;
    }

    public Vehicle userInputSearchCar() {
        String vPlateNo = userInputString("Vehicle Plate No: ");

        for (Vehicle car : manager.vehicleList) {
            if (car instanceof Car && vPlateNo.equals(car.getvPlateNo())) {
                return car;
            }
        }
        return null;
     ...
     * details.
     */
    public Vehicle userInputAddMotorbike() {
        ...
        int mModelYear = userInputInt("Model Year: ");

        Vehicle bike = new Motorbike(vPlateNo, vMake, vModel, vTransmission, vRatePerDay,
                mPetrolCapacity, mType, mModelYear);
        return bike;
    }

    public Vehicle userInputSearchMotorbike() {
        String vPlateNo = userInputString("Vehicle Plate No: ");

        for (Vehicle motorbike : manager.vehicleList) {
            if (motorbike instanceof Motorbike && vPlateNo.equals(motorbike.getvPlateNo())) {
                return motorbike;
            }
        }
        return null;
    ...
    public void logout() {
        ...
        userInput.close();
        System.out.println("Thank you for using Rental Vehicle System Service!");
        System.exit(0);
    }
